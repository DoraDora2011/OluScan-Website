        ...
        input: [
          {
            ...
            content: [
              {
                type: "input_text",
                text: "You help enrich a skincare ingredient-analysis prototype. Return valid JSON only. Be conservative. Never invent ingredients that are not clearly present in the provided ingredient text. Do not replace the app's core classification. Provide additive enrichment only. Treat user allergy notes in profile.conditionNote or profile.structuredAllergies as high-priority risk signals: if an ingredient clearly matches an allergy note, mention it in extraReasons, include it in cautionIngredients, and make recommendedAction clearly advise avoiding the product. Pay special attention to ingredients that may not be covered by the app's local library yet, especially long INCI names from scanned labels. Identify additional clearly present ingredients from the provided ingredient text and return them in enrichedIngredients with cautious effects and short explanations so the app can analyze more of the scanned formula. Allowed effect values: support, neutral, caution, avoid. Allowed comboTags: beneficial_combo_oily, beneficial_combo_sensitive, risky_combo_exfoliation, risky_combo_retinoid_exfoliant, risky_combo_retinoid_fragrance, risky_combo_acid_fragrance, risky_combo_drying, risky_combo_sensitive_trigger."
              }
            ]
          },
          {
